...
export const SOCIAL_LINKS = [
  ...
  { label: 'Twitter', href: 'https://youtu.be/xuxWlWkxLDQ?list=RDxuxWlWkxLDQ', icon: 'x' },
...
export const PROJECTS: Project[] = [
  {
    id: '1',
    title: 'Aikrut',
    description: 'B2B AI-driven Interview system and high-performance dashboards.',
    ...
    tags: ['Next.js 15', 'TypeScript', 'AI', 'Tailwind CSS'],
    category: 'SaaS',
    image: '/images/projects/aikrut.jpg',
    featured: true,
    year: 2025,
  },
  {
    id: '2',
    title: 'Skillana',
    description: 'Interview Platform Service Provider and high-performance dashboards.',
    longDescription: 'Orchestrated the migration of a legacy 2017 React codebase to Next.js, resolving critical heritage bugs and improving stability, performance, and developer experience.',
    tags: ['Next.js', 'React', 'TypeScript'],
    category: 'SaaS',
    image: '/images/projects/skillana.jpg',
    featured: false,
    year: 2025,
  },
  {
    id: '3',
    title: 'esuite (eDOT)',
    description: 'Distribution Management System (DMS) dashboards.',
    ...
    tags: ['React', 'Firebase', 'Jest', 'TypeScript', "ShadcnUI"],
    category: 'SaaS',
    image: '/images/projects/esuite.jpg',
    featured: true,
    year: 2026,
  },
  {
    id: '4',
    title: 'Hermes (eDOT)',
    description: 'Company configuration dashboards.',
  ...
  },
  {
    ...
    description: 'Secure registration and analytics flow with identity verification.',
    ...
    tags: ['Vue 2', 'Nuxt.js', 'OCR', 'Facial Recognition'],
    category: 'FinTech',
    image: '/images/projects/bsi.jpg',
    featured: true,
    year: 2023,
  },
  {
    ...
    tags: ['Vue 3', 'Nuxt.js', 'TypeScript'],
    category: 'FinTech',
    image: '/images/projects/hawkeye.jpg',
    featured: false,
    year: 2024,
  },
  {
    ...
    description: 'High-traffic event landing page and admin dashboard.',
    ...
    tags: ['Vue 2', 'Nuxt.js'],
    category: 'FinTech',
    image: '/images/projects/cimb.jpg',
    featured: false,
    year: 2022,
  },
  {
  ...
  },
  {
    ...
    tags: ['Vue 2', 'Nuxt.js', 'Vuetify', 'TypeScript'],
    category: 'FinTech',
    image: '/images/projects/privy.jpg',
    featured: false,
    year: 2022,
  },
  {
    ...
    tags: ['React', 'Vite', 'Tailwind CSS', 'ShadcnUI', 'Midtrans'],
    category: 'HealthTech',
    image: '/images/projects/prosehat.jpg',
    featured: true,
    year: 2025,
  },
  {
    ...
    tags: ['Svelte'],
    category: 'EduTech',
    image: '/images/projects/lingotalk.jpg',
    featured: false,
    year: 2021,
  },
  {
    ...
    longDescription: 'Researched and developed a camera-based face detection application using Java and Python for university thesis, focusing on real-time image processing.',
    tags: ['Java', 'Python', 'Android Studio'],
    category: 'App',
    image: '/images/projects/facedetection.jpg',
    featured: false,
    year: 2021,
  },
]
...
export const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: 'SCSS/CSS', level: 90, category: 'frontend', color: '#CC6699' },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Codeigniter', level: 80, category: 'backend', color: '#ED8B00' },
...
export const OWNER = {
  ...
  tagline: 'Results-driven Frontend Heavy - Fullstack Engineer with 5+ years of experience building scalable, high-performance web applications.',
  bio: 'Results-driven Frontend Heavy - Fullstack Engineer with 5+ years of experience building scalable, high-performance web applications using Next.js, Nuxt.js, and Laravel. Proven expertise in translating complex requirements into responsive, user-centric interfaces while maintaining code quality and performance standards. Demonstrated ability to optimize application performance by 40%, mentor development teams, and deliver features that increase user engagement and drive business value.',
  location: 'Yogyakarta, Indonesia',
